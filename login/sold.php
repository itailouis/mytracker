 ...
 <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
     <div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">View Vehicles OnTrack</li>
			</ol>
	</div><!--/.row-->
	...
	<div class="modal fade" id="insert" role="dialog" aria-labelledby="insert" aria-hidden="true">
		...
		<div class="row">
			<div class="col-lg-12">
				<h2 class="page-header">Vehicles on Track</h2>
			</div>
        ...
        <tbody>
            ...
            while ($vehicle = mysql_fetch_assoc($res)) { ?>
                ...
                <td width=50px>
                    ...
                    <a data-toggle="modal" data-target="#myModal" href="displaymap.php?action=vs_view&id=<?php echo $vehicle['v_id']; ?>" class="btn btn-info" >View</a>
