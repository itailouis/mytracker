...
<title>Vehicle Track and Management System</title>
...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="dashboard.php"><span> FPRVMS </span>Admin Area</a>
				<ul class="user-menu">
   ...
   if($userRow['u_type']=="Admin") 
	echo '<li><a href="manage_employee.php"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg>Manage Drivers</a></li><li role="presentation" class="divider"></li>';
  ?>
			...
			<li><a href="sold.php"><svg class="glyph stroked calendar"><use xlink:href="#stroked-calendar"></use></svg> Vehicles Request</a></li>
			<li><a href="sold.php"><svg class="glyph stroked calendar"><use xlink:href="#stroked-calendar"></use></svg> OnTrack</a></li>
